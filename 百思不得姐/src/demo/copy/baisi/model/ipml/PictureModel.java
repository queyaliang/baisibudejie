...
public class PictureModel implements IPictureModer {
	...
	@Override
	public void getPictureList(final int page,final AsyncCallback callback) {
		
		String url=Consts.PIC_FUNNY_URL+page;		
					...
					public void onResponse(String response) {
						...
						try {
							...
							if (code == 0) {
								...
								List<Pictures> lists = JsonParse.parsePictureList(array);
